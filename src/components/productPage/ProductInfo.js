        ...
        if (foundItem) {
          cart.map((prod, i) => {
            if (prod._id == product._id) {
              cart[i].selectedDate = selectedDate;
              cart[i].deliveryDate = deliveryDate;
              cart[i].returnDate = returnDate;
            }
          });
        } else {
          cart.push({
        ...
        <div className="productcontcenter">
          ...
          {price ? (
            disprice ? (
              <div class="flashpricecont">
                <span className="pricetitle">Rent:</span>
                ...
                <div class="dispersent">
                  <span>-{(100 - (disprice / price) * 100).toFixed(0)}%</span>
                </div>
              </div>
            ) : (
              <div className="centerprice">
          ...
          {price ? (
            <div className="securitycont">
              <span className="secupricetitle">Security Deposit:</span>
              <span className="pricesmallpart">Rs.</span>{" "}
              <span className="pricesize">20000</span>
              <span className="pricesmallpart">.00</span>
              <span className="securitytag">(Refunded)</span>
            </div>
          ) : (
            <Skeleton width={200} count={4} />
          )}
          ...
          <div className="desc_ul">
            {title ? (
              <div class="flashtimercont">
                <div class="flashtimerhead">
                  <div class="flashheadleft">Size & Dimensions</div>
                </div>
                <div class="flashtimersub">
                  <div class="flashpricecont">
                    <ul className="Dimenul">
                      <li className="desc_li">
                        <div className="li_head">Size</div>
                        <div className="li_sub artnum">XL</div>
                      </li>
                      <li className="desc_li">
                        <div className="li_head">Shoulder</div>
                        <div className="li_sub">14cm</div>
                      </li>
                      <li className="desc_li">
                        <div className="li_head">Chest</div>
                        <div className="li_sub">17cm</div>
                      </li>
                      <li className="desc_li">
                        <div className="li_head">Waist</div>
                        <div className="li_sub">06cm</div>
                      </li>
                      <li className="desc_li">
                        <div className="li_head">Top Length</div>
                        <div className="li_sub">20cm</div>
                      </li>
                      <li className="desc_li">
                        <div className="li_head">Hip</div>
                        <div className="li_sub">24cm</div>
                      </li>
                      <li className="desc_li">
                        <div className="li_head">Sleeves</div>
                        <div className="li_sub">04cm</div>
                      </li>
                      <li className="desc_li">
                        <div className="li_head">Arm Hole</div>
                        <div className="li_sub">15cm</div>
                      </li>
                      <li className="desc_li">
                        <div className="li_head">Bottom Length</div>
                        <div className="li_sub">14cm</div>
                      </li>
                      <li className="desc_li">
                        <div className="li_head">Bottom Waist</div>
                        <div className="li_sub">14cm</div>
                      </li>
                      <li className="desc_li">
                        <div className="li_head">Inner Length</div>
                        <div className="li_sub">14cm</div>
                      </li>
                    </ul>
                  </div>
      ...
      <div className="productcontright">
        ...
        <div className="infobelowleft">
          ...
          <div className="shippingchargescont">
            ...
            <div className="deliverysubcont">
              ...
              {title ? (
                <span className="estdays">01 Day</span>
              ) : (
        ...
        <div className="pricebtnscont">
          <div className="stockstatus">
            <div className="txtheading">Event / Booking Date:</div>
            <Datepicker
              selectedDate={selectedDate}
